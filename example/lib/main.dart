...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      Printer.printMapJsonLog(map1,stackTrace: StackTrace.current,prefix: "我是测试前缀:",);
      Printer.printMapJsonLog(list,stackTrace: StackTrace.current,);
      Printer.printMapJsonLog(list2,stackTrace: StackTrace.current,);
      Printer.printMapJsonLog(map,stackTrace: StackTrace.current,);
//
//      ///不推荐的使用方式
//      /// Not recommended
